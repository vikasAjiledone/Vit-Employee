...
const MachineryProcurementTable = () => {
  return (
    <div>
      <Typography variant="h1" textAlign="center" sx={{ mb: 2 }}>
      Machinery Procurement Details
      </Typography>
      <Sheet
        sx={{
...
export default MachineryProcurementTable;
