...
const ProjectEstablishmentTable = () => {
  return (
    <div>
      <Typography variant="h1" textAlign="center" sx={{ mb: 2 }}>
        Project Establishment Details
      </Typography>
      <Sheet
        sx={{
          ...
          <tbody>
            {rows.map((row) => (
              <tr key={row.name}>
                ...
                <td>
                  <Button>
                    <Link to="/ProjectEstablishmentView" style={{textDecoration:"none"}}>
                      <VisibilityIcon />
                    </Link>
                  </Button>
...
export default ProjectEstablishmentTable;
