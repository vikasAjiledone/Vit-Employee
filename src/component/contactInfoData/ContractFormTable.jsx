            ...
            <Table stickyHeader>
              <thead>
                <tr>
                  ...
                  <th>Fax</th>
                  <th>Contract mode</th>
                  <th>Key dates and Contact period</th>
                  <th>Contract Award Date</th>
                  <th>Sub-Contractor Detail</th>
                  <th>Construction Contract Agreement</th>
                  <th>Action</th>
                </tr>
              </thead>
              <tbody>
                {rows.map((row) => (
                  <tr key={row.name}>
                    ...
                    <td>
                      <Button>
                        <Link to="/ContractInfoView" style={{textDecoration:"none"}}>
                          <VisibilityIcon />
                        </Link>
                      </Button>
